...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_HCA_COMPRESS_K,                         "blk.%d.compress_k.weight" },
    { LLM_TENSOR_HCA_COMPRESS_V,                         "blk.%d.compress_v.weight" },
    { LLM_TENSOR_HCA_COMPRESS_GATE,                      "blk.%d.compress_gate.weight" },
    { LLM_TENSOR_HCA_POSITION_BIAS,                      "blk.%d.position_bias" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_HCA_COMPRESS_K,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_HCA_COMPRESS_V,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_HCA_COMPRESS_GATE,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_HCA_POSITION_BIAS,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
